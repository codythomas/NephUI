...
if not CustomIcons then
    error("NephUI: CustomIcons module not initialized! Load CustomIcons.lua first.")
end
...
function CustomIcons:UpdateTrinketWeaponTracking()
    if not NephUI.trinketsTrackerFrame then return end
...
function CustomIcons:CreateTrinketsTrackerFrame()
    if NephUI.trinketsTrackerFrame then return NephUI.trinketsTrackerFrame end
    ...
    NephUI.trinketsTrackerFrame = frame
...
function CustomIcons:ApplyTrinketsLayout()
    ...
    local container = NephUI.trinketsTrackerFrame
    local icons = {}
...
NephUI.CreateTrinketsTrackerFrame = function(self) return CustomIcons:CreateTrinketsTrackerFrame() end
NephUI.ApplyTrinketsLayout = function(self) return CustomIcons:ApplyTrinketsLayout() end
NephUI.UpdateTrinketWeaponTracking = function(self) return CustomIcons:UpdateTrinketWeaponTracking() end
