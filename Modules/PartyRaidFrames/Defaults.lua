--[[
    NephUI Unit Frames - Default Configuration
...
local SharedDefaults = {
    ...
    selectionHighlightTexture = "Interface\\AddOns\\NephUI\\Media\\uf_selected.tga",
    selectionHighlightAlpha = 0.5,
    
    -- Mouseover Highlight
    mouseoverHighlightEnabled = true,
    mouseoverHighlightTexture = "Interface\\AddOns\\NephUI\\Media\\uf_mouseover.tga",
