--[[
    NephUI Unit Frames - Frame Initialization
...
function UnitFrames:CreatePartyContainer()
    ...
    local container = CreateFrame("Frame", "NephUIPartyContainer", UIParent, "SecureFrameTemplate")
...
function UnitFrames:CreateRaidContainer()
    ...
    local container = CreateFrame("Frame", "NephUIRaidContainer", UIParent, "SecureFrameTemplate")
    container:SetSize(1, 1)
...
function UnitFrames:CreateMoverFrame(parent, name, onDragStop)
    ...
    local fontPath = NephUI and NephUI:GetGlobalFont()
    if fontPath then
