--[[
    NephUI Localization - English (enUS)
    Base locale for all English strings
--]]

local L = LibStub("AceLocale-3.0"):NewLocale("NephUI", "enUS", true)
...
L["Apply custom NephUI styling to action bars"] = "Apply custom NephUI styling to action bars"
...
L["Open the full NephUI configuration panel"] = "Open the full NephUI configuration panel"
...
L["Frame name to anchor to (e.g., EssentialCooldownViewer, NephUI_Player, NephUI_Target, UIParent)"] = "Frame name to anchor to (e.g., EssentialCooldownViewer, NephUI_Player, NephUI_Target, UIParent)"
...
-- MESSAGES & ERRORS
-- ============================================================
L["NephUI: Import failed: No data found. Please paste your import string in the Import Profile String field."] = "NephUI: Import failed: No data found. Please paste your import string in the Import Profile String field."
L["NephUI: Please enter a profile name for the imported profile."] = "NephUI: Please enter a profile name for the imported profile."
L["NephUI: Profile imported as '%s'. Please reload your UI."] = "NephUI: Profile imported as '%s'. Please reload your UI."
L["NephUI: Profile imported. Please reload your UI."] = "NephUI: Profile imported. Please reload your UI."
L["NephUI: Import failed: %s"] = "NephUI: Import failed: %s"
L["NephUI: Invalid Import String."] = "NephUI: Invalid Import String."
...
L["[NephUI] Warning: Custom GUI not loaded, using AceConfigDialog"] = "[NephUI] Warning: Custom GUI not loaded, using AceConfigDialog"
L["[NephUI] Party/Raid frames GUI not loaded."] = "[NephUI] Party/Raid frames GUI not loaded."
